...
export class AddQuestionComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    private contributeQuestionService: ContributeQuestionService, private router: Router,private authService:AuthService) {
  ...
  check(event) {
    ...
    console.log("checkbox count"+this.count);
    console.log("checkboxCount count"+this.checkboxCount);
  }
