...
public class TshellController {
	 ...
	 * LoggerFactory.getLogger(TshellController.class);
	 * 
	 * 
	 * @ExceptionHandler(Exception.class) public ResponseEntity<ErrorResponse>
	 * handleError(Exception ex) { LOGGER.info("start"); ErrorResponse error = new
	 * ErrorResponse();
	 ...
	 * error.setErrorMessage("Internal Server Error"); return new
